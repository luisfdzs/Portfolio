...
- [Perfil y datos del CV](perfil-cv.md) — qué datos son firmes, de dónde salen, qué NO se puede inventar, las dos tandas de textos del 2026-08-04 (la segunda la escribió Luis en el inspector del navegador: aquí está cómo se recoge eso) y las tres podas de formación
...
- [Decisiones de diseño](decisiones-de-diseno.md) — oscuro sin conmutador, serif de titular, un solo acento, texto centrado, experiencia centrada moviendo la CABECERA y no la lista (y las dos vueltas anteriores que lo intentaron al revés), hoja de impresión
